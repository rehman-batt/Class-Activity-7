...
def preprocess_data():
    df = pd.read_csv(r"D:\Fast NU\7th semester (pro max plus) shit\MLOps\Class-Activity-7\airflow_pipeline\dags\src\datasets\data.csv")
    ...
    df.to_csv(r"D:\Fast NU\7th semester (pro max plus) shit\MLOps\Class-Activity-7\airflow_pipeline\dags\src\datasets\processed_data.csv", index=False)
